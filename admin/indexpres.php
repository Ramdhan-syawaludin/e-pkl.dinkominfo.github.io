...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <button class="btn btn-link btn-sm text-white order-1 order-sm-0" id="sidebarToggle" href="#">
       <a class="navbar-brand mr-1" href="#">Kelola Presensi</a>
...
<!--           <button class="btn btn-primary" type="button">
  ...
  <div id="wrapper">
    ...
    <div class="sidebar-header">
      ...
      <li class="nav-item">
        <a class="nav-link" href="indexpres.php?halaman=userfinger">
      ...
      <li class="nav-item">
        <a class="nav-link" href="indexpres.php?halaman=ip">
          <i class="fas fa-fw fa-users"></i>
          <span>IP Address</span></a>
      </li>

     <li class="nav-item">
        <a class="nav-link" href="indexpres.php?halaman=mk">
          <i class="fas fa-fw fa-users"></i>
      ...
      <div class="container-fluid">
          ...
          <?php 
            if (isset($_GET['halaman'])) {
              ...
              elseif ($_GET['halaman']=="userfinger") {
                include'userfinger.php';
              }

              elseif ($_GET['halaman']=="ip") {
                include'ip.php';
              }
