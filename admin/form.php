									...
									<h2>Kelola Formulir</h2>
										 ...
										 <table id="dataTable3" class="table table-hover" style="width:100%"><thead class="thead-dark">
											...
											while($b=mysqli_fetch_array($form)){
												...
												<tr>
													<td><?php echo $no++ ?></td>
													<td><?php echo $b['namainstansi'] ?></td>
													<td><?php echo $b['bidangpkl'] ?></td>
													<td><?php echo $b['tglkonfirmasi'] ?></td>
                                                    <td><?php echo $b['seleksi'] ?></td>
                                                    <td><a class="btn btn-primary btn-sm" href="view.php?u=<?php echo $b['userid'];?>">Lihat Detail</a></br></td>
												</tr>		
												<?php 
											}
											?>
