...
<head>
    ...
    <title>Dinkominfo: Hasil Seleksi</title>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                ...
                <div class="market-status-table mt-5">
                    <div class="col-12">
                            <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h5 class="mb-5 margin text-center">Selamat anda telah Diterima untuk melaksanakan PKL pada Dinas Komunikasi dan Informatika Blora</h5>
                                    <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                <br>
                                                        <a href target="_blank" src="<?php echo $ambil['suratbalasan']?>" class="btn btn-info center">Cetak Surat Balasan</a>
                                                </div>
                                            </div>
                                    </div>      
                                </div>
