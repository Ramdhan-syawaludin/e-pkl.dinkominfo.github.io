                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 Selamat! Data Anda sudah tersimpan dan terdaftar.
                                        </div>
...
<!------------------ Pisahin ------------------->
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    ...
                                    <div class="row">
                                            <div class="col">
                                            <div class="form-group">
                                                <label>Telepon Sekolah / Perguruan Tinggi</label>
        ...
        <footer>
            <div class="footer-area">
                <p>Copyright © 2023 Dinas Komunikasi dan Informatika Kabupaten Bloras</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
