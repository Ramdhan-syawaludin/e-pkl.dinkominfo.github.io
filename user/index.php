...
<head>
    ...
    <title>Dinkominfo: User Dashboard</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                         ...
                                         <br>3. Klik Simpan, kemudian klik Konfirmasi. Setelah dikonfirmasi, data tidak dapat diubah kembali.
                                         <br>
                                         <br>*Note: Pihak Dinkominfo baru akan menerima data Anda setelah Anda klik 'Konfirmasi'
                                    </div>
                                </div>
                            </div>
                        </div>
